...
@Path("/vowp")
public class Vow_Descending {
	@GET
	public static void vow() throws Exception {

		Document document = new Document();
		PdfWriter writer = PdfWriter.getInstance(document,
				new FileOutputStream("D:\\1 MNC Project\\PDF\\Vow_Performance.pdf"));
		document.open();
		...
		ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER,
				new Phrase("Performance wise VOW report"), 285, 705, 0);
