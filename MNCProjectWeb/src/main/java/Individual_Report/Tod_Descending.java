...
@Path("/todp")
public class Tod_Descending {  	
	@GET
        public static void tod() throws Exception{
                
           
                Document document = new Document();
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("D:\\1 MNC Project\\PDF\\Tod_Performance.pdf"));
                document.open();   
              
                document.addTitle("Tod Reports");
                ...
                ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase("Performance wise TOD report"), 285, 705, 0);
