...
public class Cod_Descending {
	...
	public  void cod() throws Exception {
		...
		PdfWriter writer = PdfWriter.getInstance(document,
				new FileOutputStream("D:\\1 MNC Project\\PDF\\Cod_Performance.pdf"));
		document.open();

		document.addTitle("Cod Reports");
		...
		ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER,
				new Phrase("Performance wise COD report"), 285, 705, 0);
		...
		Collection<PanchatanthraDTO> sc = sd.sortByCod();
