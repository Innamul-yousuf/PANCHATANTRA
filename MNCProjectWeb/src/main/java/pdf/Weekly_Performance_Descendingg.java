...
public class Weekly_Performance_Descendingg {
	public static void main(String[] args) throws Exception {

		Document document = new Document();
		PdfWriter writer = PdfWriter.getInstance(document,
				new FileOutputStream("D:\\1 MNC Project\\PDF\\Weekly_Report_Descending.pdf"));
		document.open();
		...
		document.addTitle("Panchatanthra Descending Reports");
		...
		ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER,
				new Phrase("Performance wise weekly report"), 285, 705, 0);
