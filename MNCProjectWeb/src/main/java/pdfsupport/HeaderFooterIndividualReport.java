...
import com.itextpdf.text.pdf.ColumnText;
	...
	public class HeaderFooterIndividualReport extends PdfPageEventHelper {
	    ...
	    public void onStartPage(PdfWriter writer, Document document) {
	    	...
	    	//FileReader reader = new FileReader("individualpdf.properties");
	    	...
	    	writer.setPageEvent(new PDFBackgroundIndividual());
	    	}
